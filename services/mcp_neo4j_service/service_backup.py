    ...
    async def initialize_mcp_connection(self):
        ...
        try:
            ...
            try:
                ...
                server_command = ["python", os.path.join(os.path.dirname(os.path.dirname(__file__)), "..", "mcp_servers", "mcp_neo4j_server.py")]
                global mcp_process
                ...
                read, write = mcp_process.stdout, mcp_process.stdin
                async with stdio_client(read, write) as (read, write):
                ...
                return {
                    ...
                    "result": {
                        "centrality_analysis": {
                            ...
                            "top_nodes": [
                                {"node": "Stakeholder_1", "centrality": 0.25},
                                {"node": "Stakeholder_2", "centrality": 0.20},
                                {"node": "Decision_Factor_A", "centrality": 0.18}
                            ],
                ...
                return {
                    ...
                    "result": {
                        "community_detection": {
                            "algorithm": "louvain",
                            "communities": [
                                {"community_id": 1, "nodes": ["A", "B", "C"], "size": 3},
                                {"community_id": 2, "nodes": ["D", "E"], "size": 2}
                            ],
                            "modularity": 0.42,
                            "total_communities": 2
                        }
