...
ASSISTANT_NAME = os.environ.get('ASSISTANT_NAME', "DADM Basic Assistant")
...
You are a simple OpenAI Assistant that processes basic tasks and provides structured responses.

Your role is to:
1. Carefully read and understand task instructions
2. Provide clear, concise responses
3. Format your responses as requested
