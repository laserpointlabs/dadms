        ...
        try:
            ...
            try:
                ...
                if mcp_process.poll() is not None:
                    ...
                    raise Exception(f"MCP server process failed to start. Exit code: {mcp_process.returncode}, stderr: {stderr_output}")                # For now, skip MCP server and use mock implementation
                raise Exception("MCP client integration temporarily disabled due to API complexity")
