...
- **[Agent Assistant & Documentation Service (AADS) API](aads_service_openapi.yaml)** (Port 3005) - **📋 SPECIFICATION: Decision finalization with AI assistance, collaboration & approval workflows**
  - **[Detailed API Endpoints](../development/backend/aads_service_api_endpoints.md)** - Comprehensive API reference with examples
...
- **[Thread Manager Service API](thread_manager_service_openapi.yaml)** (Port 3008) - **📋 SPECIFICATION: Process thread tracking with feedback collection, similarity analysis & impact assessment**
  - **[Detailed API Endpoints](../development/backend/thread_manager_service_api_endpoints.md)** - Comprehensive API reference with examples
