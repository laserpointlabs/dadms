...
class EnhancedServiceOrchestrator:
    ...
    def __init__(
        ...
        """
        Initialize the EnhancedServiceOrchestrator
        ...
        self._session.headers.update({
            ...
            'User-Agent': 'DADM-EnhancedServiceOrchestrator/1.0'
        })
        ...
        logger.info(f"Initialized EnhancedServiceOrchestrator with registry: {self.service_registry}")
